...
import TargetResourceTable from './TargetResourceTable'
                ...
                <div className="amal-target-resource" style={{minHeight: 100, padding: 32}}>
                    <Grid container spacing={16}>
                        ...
                        <Grid item xs={6} style={{display: 'table-cell', verticalAlign: 'middle'}}>
                            <img src="static/frontend/logo-eamena.svg"
                                 style={{display: 'block', margin: '6px 0 0 auto'}}/>
                        </Grid>
                    </Grid>
                    <Grid container spacing={8} direction="column" style={{ marginTop: 16 }}>
                        ...
                        <Grid item xs={12}>
                            <TargetResourceTable resources={this.state.resources}/>
                        </Grid>
                    </Grid>
                </div>
            </Paper>
